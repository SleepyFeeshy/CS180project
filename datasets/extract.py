...
crop_images_from_csv("image_and_annotations.csv", "image.csv", "Car Counting.v1i.coco/train", f"datasets/train_{imageSize}x{imageSize}", 224)

crop_images_from_csv("test_img_and_anno.csv", "test_img.csv", "Car Counting.v1i.coco/test", f"datasets/test_{imageSize}x{imageSize}", 224)
